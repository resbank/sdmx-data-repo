...
(defn upload-historical-data-message [db data-message {agencyid :agency-id id :resource-id version :version} {validate? :validate next-release :nextRelease release-description :releaseDescription :or {validate? true}}]
