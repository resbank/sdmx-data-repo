...
-- NB A GiST index cannot be created on the column of the INT range type. Requires extension:
-- CREATE EXTENSION btree_gist;

-- :name create-observation-table
-- :command execute
-- :result raw
-- :doc Create observation table, if it doesn't already exist. Each observation has a 'lifetime' which is a time range for which the observation is valid. An observation is live if the upper bound of its lifetime is infinite and is dead if it is not.
